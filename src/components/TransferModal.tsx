      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
          <button 
            type="button" 
            onClick={onClose} 
            className="px-5 py-2 flex items-center justify-center border border-slate-200 text-slate-600 rounded-xl font-semibold text-xs cursor-pointer hover:bg-slate-50"
          >
            Batal
          </button>
