      ...
      <div className="flex-1 max-w-md mx-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-[14px] bg-slate-50 border border-slate-300 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition-all duration-150"
          />
        </div>
      </div>
